...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        if (typeof jQuery === 'undefined') {
            throw 'jquery.softleader.grid.js requires jQuery to be loaded first';
        }
        if (typeof form2js === 'undefined') {
            throw 'jquery.softleader.grid.js requires form2js.js to be loaded first';
        }
	...
	'use strict';
	if (!jQuery) {
        throw new Error('jquery.softleader.grid.js requires jQuery to be loaded first');
    }
	if (!form2js) {
        throw new Error('jquery.softleader.grid.js requires form2js.js to be loaded first');
    }
