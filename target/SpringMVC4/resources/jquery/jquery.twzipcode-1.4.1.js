    ...
    var methods = {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $('<input  class="form-control col-sm-2" style="width:80px"/>').attr({'type': 'text', 'name': opts.zipcodeName, 'readonly': opts.readonly}).appendTo(this);
                $('<select class="form-control col-sm-1" style="width:auto;" />').attr({'name': opts.countyName}).appendTo(this);
                $('<select class="form-control col-sm-1" style="width:auto;" />').attr({'name': opts.districtName}).appendTo(this);
